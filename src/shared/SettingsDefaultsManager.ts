...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENAI_MAX_OUTPUT_TOKENS: string;
  CLAUDE_MEM_OPENAI_REASONING_EFFORT: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENAI_API_KEY: '',  // Empty by default, can be set via UI or ~/.claude-mem/.env
    CLAUDE_MEM_OPENAI_MODEL: 'gpt-5.2-codex',  // Codex API model via OpenAI Responses API
