...
| Setting                                      | Default                     | Description                           |
|----------------------------------------------|-----------------------------|---------------------------------------|
| `CLAUDE_MEM_CODEX_PATH`                      | `codex`                     | Codex CLI command or absolute executable path. On Windows, the default also probes the Codex Desktop install path |
...
| `CLAUDE_MEM_TRANSCRIPTS_ENABLED` | `true`                       | Enable passive transcript watching. Set to `false` to keep search/MCP running without automatic compression |
| `CLAUDE_MEM_TRANSCRIPTS_CONFIG_PATH` | `~/.claude-mem/transcript-watch.json` | Transcript watcher config path |
